            ...
            <div class="col-12">
               ...
               <div class="row mb-4 mt-2">
                  ...
                  <div class="col-12 pb-2">
                     ...
                     <input disabled class="form-control font-thai fw-bold" type="text" id="Name" :value="modalInfo[0]?.name" />
                  </div>
                  <div class="col-12 pb-3">
                     <label for="Company" class="font-thai">หน่วยงาน <span>(Organization / Company)</span></label>
                     <input disabled class="form-control font-thai fw-bold" type="text" id="Company" :value="modalInfo[0]?.company" />
                  </div>
               ...
               <div class="row mb-4" align="end">
                  <div class="col-4">
                     <button type="button" class="w-100 btn btn-success btn-sm rounded-pill font-thai" data-bs-dismiss="modal" @click="handleConfirm(modalInfo[0])">
                        ยืนยัน<span>(Confirm)</span>
                     </button>
                  </div>
                  <div class="col-4">
                     <button type="button" class="w-100 btn btn-danger btn-sm rounded-pill  font-thai" data-bs-toggle="modal" data-bs-target="#cancelModal" @click="infoCancel = modalInfo[0]">
                        ยกเลิก<span>(Cancel)</span>
                     </button>
                  </div>
                  <div class="col-4" align="center">
                     <button type="button" class="w-100 btn btn-secondary btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#timelineModal">
                        Timeline
                     </button>
                  </div>
               </div>
               ...
               <div class="row mb-4">
                  ...
                  <div class="col-12 pb-2">
                     ...
                     <input disabled class="form-control font-thai " type="text" id="nameVisit" :value="modalInfo[0]?.toVisit" />
                  </div>
                  <div class="col-12 pb-2">
                     <label for="purpose" class="font-thai">ติดต่อภารกิจเรื่อง <span>(Contact Purpose)</span></label>
                     <textarea disabled class="form-control font-thai " rows="3" id="purpose" :value="modalInfo[0]?.purposeVisit"></textarea>
                  </div>
                  <div class="col-12">
                     <div class="row">
                        ...
                        <div class="col-7 pt-2">
                           <input disabled class="form-control " type="text" id="visitDate" :value="modalInfo[0]?.visitDate.split('-').reverse().join('/')" />
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-12">
                     <div class="row">
                        ...
                        <div class="col-6 pt-2">
                           <input disabled class="form-control " type="text" id="atkDate" :value="modalInfo[0]?.atkDate.split('-').reverse().join('/')" />
                        </div>
                     </div>
                  </div>
                  <div class="col-12">
                     ...
                     <table class="table table-hover text-center text-sm-center">
                        ...
                        <tbody>
                           <tr v-for="info,i in optionQuestion" :key="i">
                              ...
                              <td>
                                 <input v-if="question[0][i] == 'true'" type="radio" class="form-check-input" checked disabled>
                                 <input v-else type="radio" class="form-check-input " disabled>
                              </td>
                              <td>
                                 <input v-if="question[0][i] == 'false'" type="radio" class="form-check-input" checked disabled>
                                 <input v-else type="radio" class="form-check-input " disabled>
                              </td>
                           </tr>
                        </tbody>
                  ...
                  <div class="col-12">
                     <div class="row">
                        ...
                        <div v-if="modalInfo.length != 1" class="col-12" align="end">
                           <button type="button" class="btn btn-primary font-thai btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#entourageModal">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="col-12">
               ...
               <textarea class="form-control pt-3" placeholder="ไม่เกิน 100 ตัวอักษร" rows="4" id="comment" v-model="note"></textarea>
            </div>
         </div>
         <div class="modal-footer">
            <div class="row">
               <div class="col-6">
                  <button type="button" class="btn btn-success btn-sm rounded-pill font-thai" data-bs-dismiss="modal" @click="handleCancel()">
                     ยืนยัน<span>(Confirm)</span>
                  </button>
               </div>
               <div class="col-6">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body" style="height: 80vh">
            ...
            <div class="row py-2" v-for="info,i in modalInfo.slice(1)" :key="i">
               ...
               <div class="col-6 pb-2">
                  <label for="firstdate" class="font-thai">เข็มที่ <b>1</b> วันที่ <br /><span class="small text-nowrap">
                        (Date of 1st dose vaccination)</span></label>
                  <input disabled class="form-control" type="text" :value="info?.doseDate1.split('-').reverse().join('/')" />
               </div>
               <div class="col-6 pb-2">
                  <label for="vaccine1" class="font-thai">ชื่อวัคซีน <br /><span class="text-nowrap">
               ...
               <div class="col-6 pb-2">
                  <label for="seconddate" class="font-thai">เข็มที่ <b>2</b> วันที่ <br /><span class="small text-nowrap">
                        (Date of 2nd dose vaccination)</span></label>
                  <input disabled class="form-control" type="text" :value="info?.doseDate2.split('-').reverse().join('/')" />
               </div>
               <div class="col-6 pb-2">
               ...
               <div class="col-12">
                  <div class="row">
                     ...
                     <div class="col-6 pt-2">
                        <input disabled class="form-control" type="text" id="atkDate" :value="info?.atkDate.split('-').reverse().join('/')" />
                     </div>
                  </div>
               </div>
               <div class="col-12">
                  ...
                  <table class="table table-hover text-center text-sm-center">
                     ...
                     <tbody>
                        <tr v-for="info,j in optionQuestion" :key="j">
                           ...
                           <td>
                              <input v-if="question[i + 1][j] == 'true'" type="radio" class="form-check-input" checked disabled>
                              <input v-else type="radio" class="form-check-input " disabled>
                           </td>
                           <td>
                              <input v-if="question[i + 1][j] == 'false'" type="radio" class="form-check-input" checked disabled>
                              <input v-else type="radio" class="form-check-input " disabled>
                           </td>
                        </tr>
                     </tbody>
                     ...
                     <table class="table table-hover text-center position-relative">
                        ...
                        <tbody>
                           <tr v-for="data,j in timeline[i + 1]" :key="j">
                              ...
                              <td>
                                 <input disabled type="text" class="form-control font-thai form-control-sm" id="destination" :value="data.location">
                              </td>
                              <td>
                                 <input disabled type="text" class="form-control font-thai form-control-sm" id="destination" :value="data.vehicle">
                              </td>
                           </tr>
                        </tbody>
                     </table>
