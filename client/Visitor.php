...
<body>
   <div class="container-fluid" id="visitor">
      ...
      <div class="d-flex justify-content-center align-items-center mb-3 pt-1 h-100">
         <div class="card shadow-sm overflow-auto" style="width: 96vw; height: 89vh">
            ...
            <div class="card-body">
               <div class="row">
                  <div class="col-12 col-lg-5 mb-3 border-end border-2">
                     <?php include_once "./components/visitorPage/Information.php" ?>
                  </div>
                  <div class="col-12 col-lg-7 mb-2 overflow-auto" style="height: 75vh;">
